...
$conf['settings']['script.url'] = 'https://www.terasoftec.com/yanbal/Web';
...
$conf['settings']['database']['user'] = 'yanbal';
$conf['settings']['database']['password'] = 'Yanbal2020.';
$conf['settings']['database']['hostspec'] = '107.180.39.243';
$conf['settings']['database']['name'] = 'jfpl';
