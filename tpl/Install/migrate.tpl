...
{include file='globalheader.tpl' Title='Agenda Capacitaciones Yanbal v2 Migration'}

<h1>Migrate phpScheduleIt v1.2 to Agenda Capacitaciones Yanbal v2.x (MySQL only)</h1>
	...
	{else}
		...
		<div class="error">
			...
			<ul style="margin-left: 30px;">
				...
				<li>At the time of writing, Agenda Capacitaciones Yanbal 2 is not available in all of the same languages that 1.2 was.
