...
<div id="page-support-and-credits" class="admin-page">
    ...
    <div class="default-box col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <h1>About Agenda Capacitaciones Yanbal</h1>

        <h2>Support</h2>

        <p><a href="https://www.bookedscheduler.com/">Agenda Capacitaciones Yanbal Official Home</a></p>
        <p><a href="http://www.terasoftec.com">Terasoft Ec Solutions</a></p>
        <p><a href="http://php.brickhost.com/forums/">Agenda Capacitaciones Yanbal Community Support</a></p>
        ...
        <ul>
            <li>Prieto Linares, Jorge Fidel</li>
            <li>Dung Le</li>
            <li>Jan Mattila</li>
            <li>Paul Menchini</li>
        </ul>
        ...
        <p>Agenda Capacitaciones Yanbal free and open source, licenced under the GNU GENERAL PUBLIC LICENSE. Please see the included
