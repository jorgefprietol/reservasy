=======================
Setting up the Saml Authentication plugin for Agenda Capacitaciones Yanbal version 2.4
=======================
Changes:
...
Install SAML 2.0 Service Provider on the same server where Agenda Capacitaciones Yanbal
...
2) In the Agenda Capacitaciones Yanbal ROOT_DIRECTORY/config/config.php file,
