...
// the SP should be installed on the same server as Agenda Capacitaciones Yanbal
...
//
// SAML attriubute that is mapped to Agenda Capacitaciones Yanbal username
$conf['settings']['simplesamlphp.username'] = 'sAMAccountName';
// SAML attriubute that is mapped to Agenda Capacitaciones Yanbal firstname
$conf['settings']['simplesamlphp.firstname'] =  'givenName';
// SAML attriubute that is mapped to Agenda Capacitaciones Yanbal lastname
$conf['settings']['simplesamlphp.lastname'] = 'sn';
//SAML attriubute that is mapped to Agenda Capacitaciones Yanbal email
$conf['settings']['simplesamlphp.email'] = 'mail';
//SAML attriubute that is mapped to Agenda Capacitaciones Yanbal phone
$conf['settings']['simplesamlphp.phone'] = 'telephoneNumber';
//SAML attriubute that is mapped to Agenda Capacitaciones Yanbal organization
$conf['settings']['simplesamlphp.organization'] = 'department';
//SAML attriubute that is mapped to Agenda Capacitaciones Yanbal position
