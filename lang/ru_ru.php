...
class ru_ru extends en_gb
{
	...
	protected function _LoadStrings()
	{
		...
		// Install
		$strings['InstallApplication'] = 'Установка Agenda Capacitaciones Yanbal (только MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Нет необходимости обновления. Запуск процесса установки удалит все существующие данные и установить новую копию Agenda Capacitaciones Yanbal!';
		...
		$strings['InstalledVersion'] = 'Сейчас у вас запущена версия %s Agenda Capacitaciones Yanbal';
		...
		$strings['ConfigureApplication'] = 'Настроить Agenda Capacitaciones Yanbal';
