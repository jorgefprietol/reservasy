...
<h1 xmlns="http://www.w3.org/1999/html">Agenda Capacitaciones Yanbal Administration</h1>
...
<p>Grup di Agenda Capacitaciones Yanbal mengatur pengguna, mengontrol izin akses resource dan menentukan peran yang berlaku pada aplikasi.</p>
...
<p>Anda dapat menambah, melihat, dan mengatur semua pengguna yang terdaftar dalam menu Pengguna. Utilitas ini memungkinkan Anda untuk mengganti akses izin resouce per pengguna, menonaktifkan atau menghapus akun, mengatur ulang kata sandi pengguna, dan menyunting rincian pengguna. Anda juga dapat menambah pengguna baru ke Agenda Capacitaciones Yanbal. Hal ini sangat berguna jika pendaftaran sendiri (self-registration) dimatikan.</p>
...
<p>Dalam Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">sebuah tugas jadwal bisa digunakan</a>. Tugas harus dikonfigurasi agar berjalan setiap menit. Tugas untuk menjalankan adalah php diikuti dengan alamat lengkap untuk file Agenda Capacitaciones Yanbal/Jobs/sendreminders.php</p>

<h2>Konfigurasi</h2>

<p>Beberapa fungsi Agenda Capacitaciones Yanbal hanya bisa dikontrol dengan menyunting file config.</p>

<p class="setting"><span>$conf['settings']['server.timezone']</span>Konfigurasi ini harus merefleksikan zona waktu dari server yang terdapat Agenda Capacitaciones Yanbal. Server ini sekarang diatur pada <em>{$ServerTimezone}</em>. Lihat daftarnya di sini: <a href="http://php.net/manual/en/timezones.php" target="_blank">http://php.net/manual/en/timezones.php</a></p>
...
<p class="setting"><span>$conf['settings']['enable.email']</span>Mengirim atau tidak setiap email dari Agenda Capacitaciones Yanbal</p>

<p class="setting"><span>$conf['settings']['default.language']</span>Bahasa standar untuk semua pengguna. Bisa menggunakan bahasa yang terdapat pada direktori bahasa Agenda Capacitaciones Yanbal.</p>

<p class="setting"><span>$conf['settings']['script.url']</span>URL publik lengkap untuk sumber dari Agenda Capacitaciones Yanbal. Harus berisikan direktori Web yang terdapat file seperti booking.php dan calendar.php</p>
...
<p class="setting"><span>$conf['settings']['image.upload.directory']</span>Direktori untuk menyimpan gambar. Direktori ini harus bisa ditulis (writeable/755 sugeted). Bisa berupa direktori lengkap atau bergantung pada Agenda Capacitaciones Yanbal direktori utama.</p>
...
<p class="setting"><span>$conf['settings']['database']['name']</span>Nama database dari Agenda Capacitaciones Yanbal.</p>
...
<p class="setting"><span>$conf['settings']['api']['enabled']</span>Jika RESTful API Agenda Capacitaciones Yanbal harus diaktifkan. Lihat lebih lanjut syarat-syarat untuk menggunakan API pada file readme_installation.html. Pilihannya 'true' atau 'false'.</p>
