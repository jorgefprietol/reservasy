...
File ini adalah bagian dari Agenda Capacitaciones Yanbal.
...
(dengan pilihan) versi apapun setelahnya Agenda Capacitaciones Yanbal didistribusikan dengan harapan akan berguna,
tapi TANPA JAMINAN; Agenda Capacitaciones YanbalduleIt is distributed in the hope that it will be useful,
...
bersamaa Agenda Capacitaciones Yanbal. Jika tidak, lihat
<http://www.gnu.org/licenses/>.

*}
{include file='globalheader.tpl'}
Agenda Capacitaciones Yanbal</h1>

<div id="help">
<h2>Pendaftaran</h2>

<p>Pendaftaran dibutuhkan unt Agenda Capacitaciones Yanbal jika administrator telah mengaktifkannya. Setelah akun Anda telah terdaftar, Anda bisa log in dan mengakses resources yang diizinkan untuk Anda.</p>
...
<p>Pada beberapa kasus, cukup mengklik tautan Berlangganan ke Kalender ini akan otomatis mengatur berlangganan pada Program Kalender. Untuk Outlook, jika tidak terjadi otomatis penambahan, buka Kalender, dan klik kanan Kalender saya dan pilih Tambah Kalender -> Dari Internet. Salin URL yang terlihat di bawah tautan BerlangganAgenda Capacitaciones Yanbalni pada Agenda Capacitaciones Yanbal.</p>

<h3>Kalender Google&reg;</h3>

<p>Buka pengaturan Kalender Google. Klik Kalender tab. Klik telusiri kalender yang menarik. Klik dan tambah dengan URL. Salin URL yang terlihat di bawah tautan BerlangAgenda Capacitaciones Yanbalr ini pada Agenda Capacitaciones Yanbal.</p>
