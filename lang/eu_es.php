...
class eu_es extends en_gb
{
    ...
    protected function _LoadStrings()
    {
		...
		// Install
		$strings['InstallApplication'] = 'Agenda Capacitaciones Yanbal instalatu (MySQL baino ez)';
		...
		$strings['NoUpgradeNeeded'] = 'Ez da beharrezkoa eguneratzea. Instalazio prozesua abiatuz gero dauden datu guztiak ezabatuko dira eta Agenda Capacitaciones Yanbal-en kopia berri bat instalatuko da!';
		...
		$strings['InstalledVersion'] = 'Une honetan Agenda Capacitaciones Yanbal-en %s bertsioa erabiltzen ari zara';
		...
		$strings['ConfigureApplication'] = 'Agenda Capacitaciones Yanbal konfiguratu';
