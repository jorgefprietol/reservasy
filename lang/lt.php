...
class lt extends en_gb
{
	...
	protected function _LoadStrings()
	{
		...
		// Install
		$strings['InstallApplication'] = 'Diegti Agenda Capacitaciones Yanbal (tik su MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Atnaujinimas neb�tinas. Leid�iant diegim� bus i�trinta visi esami duomenys ir �diegta nauja Agenda Capacitaciones Yanbal kopija!';
		...
		$strings['InstalledVersion'] = 'Naudojat�s Agenda Capacitaciones Yanbal, versija %s ';
		...
		$strings['ConfigureApplication'] = 'Nustatyti Agenda Capacitaciones Yanbal';
