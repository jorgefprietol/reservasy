...
class pt_pt extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['NoUpcomingReservations'] = 'Não tem futuras Capacitaciones';
        $strings['UpcomingReservations'] = 'Futuras Capacitaciones';
        ...
        $strings['ResourceRequiresApprovalNone'] = 'Capacitaciones não necessitam aprovação';
        ...
        $strings['ResourceMinNoticeNone'] = 'As Capacitaciones podem ser feitas até o tempo atual';
        $strings['ResourceMaxNotice'] = 'As Capacitaciones não devem terminar mais de %s a partir do tempo atual';
	...
	$strings['ReservationDeletedPreference'] = 'Quando eu excluir uma reserva ou uma reserva é excluída em meu nome';
        ...
        $strings['DeleteAccessoryWarning'] = 'Apagar este acessório irá removê-lo de todas as Capacitaciones.';
        $strings['AddAccessory'] = 'Adicionar acessório';
        $strings['AddBlackout'] = 'Adicionar horário indisponível';
        $strings['AllResourcesOn'] = 'Todos Salas em';
        $strings['Reason'] = 'Razão';
        $strings['BlackoutShowMe'] = 'Mostrar Capacitaciones em conflito';
        $strings['BlackoutDeleteConflicts'] = 'Excluir Capacitaciones em conflito';
        ...
        $strings['ReservationConflicts'] = 'Existem horários de Capacitaciones em conflito';
        $strings['UsersInGroup'] = 'Utilizadores neste grupo';
        $strings['Browse'] = 'Navegar';
        $strings['DeleteGroupWarning'] = 'Apagar este grupo irá remover todas as permissões de Salas associados. Os utilizadores deste grupo podem perder o acesso aos Salas.';
        ...
        $strings['DeleteUserWarning'] = 'Apagar este usuário irá remover todas as suas Capacitaciones atuais, futuros e histórico.';
        ...
        $strings['MyReservation'] = 'As minhas Capacitaciones';
        ...
        $strings['NoResourceAdministratorLabel'] = '(Nenhum administrador de Salas)';
        $strings['WhoCanManageThisResource'] = 'Quem pode gerir este recurso?';
        $strings['ResourceAdministrator'] = 'Administrador de Salas';
	...
	$strings['Maximum'] = 'máximo';
        ...
        $strings['NoResourcePermission'] = 'Não tem permissão para aceder a um ou mais dos Salas solicitados';
        $strings['ConflictingReservationDates'] = 'Há Capacitaciones em conflito nas seguintes datas:';
        ...
        $strings['GroupReservations'] = 'Capacitaciones para Grupos';
        $strings['ResourceReservations'] = 'Capacitaciones de Recurso';
