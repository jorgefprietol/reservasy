...
<div id="help">
	...
	<div id="help-resources">
		...
		<p>Resources in Agenda Capacitaciones Yanbal can be anything you want to make bookable, such as rooms or equipment. Every resource
	...
	<div id="help-configuration">
		...
		<p class="setting"><span>$conf['settings']['enable.email']</span>Whether or not any emails are sent out of Agenda Capacitaciones Yanbal
		</p>
		...
		<p class="setting"><span>$conf['settings']['script.url']</span>The full public URL to the root of this instance of
			Agenda Capacitaciones Yanbal. This should be the Web directory which contains files like bookings.php and calendar.php. If this
		...
		<p class="setting"><span>$conf['settings']['uploads']['reservation.attachment.path']</span>The full or relative
			filesystem path (relative to the root of your Agenda Capacitaciones Yanbal directory) to store reservation attachments. This
		...
		<p class="setting"><span>$conf['settings']['api']['enabled']</span>If the Agenda Capacitaciones Yanbal's RESTful API should be enabled.
	...
	<p class="setting"><span>$conf['settings']['wp_includes.directory']</span>The full path to your wp-includes directory or path relative to Agenda Capacitaciones Yanbal
		root.</p>

	<p class="setting"><span>$conf['settings']['database.auth.when.wp.user.not.found']</span>If WordPress auth fails, authenticate against Agenda Capacitaciones Yanbal
		database.</p>
