...
<h1>Agenda Capacitaciones Yanbal Laguntza</h1>

<div id="help">
<h2>Erregistroa</h2>

<p>
	Erregistratzea derrigorrezkoa Agenda Capacitaciones Yanbal erabili ahal izateko, kudeatzaileak horrela aktibatu badu.
