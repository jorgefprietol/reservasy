...
class cz extends en_us
{
	...
	protected function _LoadStrings()
	{
		...
		// Install
		$strings['InstallApplication'] = 'Instalace Agenda Capacitaciones Yanbalu (pouze pro MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Žádná aktualizace není potřeba. Opětovné spuštění instalačního procesu smaže veškerá stávající data a znovu nainstaluje Agenda Capacitaciones Yanbal!';
		...
		$strings['InstalledVersion'] = 'Nainstalovaná verze Agenda Capacitaciones Yanbalu je %s';
		...
		$strings['ConfigureApplication'] = 'Nastavit Agenda Capacitaciones Yanbal';
