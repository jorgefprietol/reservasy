...
class sr_sr extends en_gb
{
	...
	protected function _LoadDays()
	{
		 ...
		 ***/
		// The full day name
		$days['full'] = array('Nedelja', 'Ponedeljak', 'Utorak', 'Sreda', 'Četvrtak', 'Petak', 'Subota');
		// The three letter abbreviation
		$days['abbr'] = array('Ned', 'Pon', 'Uto', 'Sre', 'Čet', 'Pet', 'Sub');
	...
	protected function _LoadMonths()
	{
		 ...
		 ***/
		// The full month name
		$months['full'] = array('Januar', 'Februar', 'Mart', 'April', 'Maj', 'Jun', 'Jul', 'Avgust', 'Septembar', 'Oktobar', 'Novambar', 'Decembar');
