...
class si_si extends en_gb
{
    ...
    protected function _LoadStrings()
    {
		...
		// Install
		$strings['InstallApplication'] = 'Namesti program Agenda Capacitaciones Yanbal (samo MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Nadgradnja ni potrebna. Ko boste pognali namestitveni proces, se bodo zbrisali vsi obstoječi podatki in namestila se bo nova kopija programa Agenda Capacitaciones Yanbal!';
		...
		$strings['InstalledVersion'] = 'Trenutno teče različica %s programa Agenda Capacitaciones Yanbal';
		...
		$strings['ConfigureApplication'] = 'Konfiguracija programa Agenda Capacitaciones Yanbal';
