...
class it_it extends en_gb
{
	...
	protected function _LoadStrings()
	{
		...
		// Install
		$strings['InstallApplication'] = 'Installa Agenda Capacitaciones Yanbal (solo MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Non è necessario alcun aggiornamento. L\'installazione cancella tutti i dati esistenti e installa una nuova copia di Agenda Capacitaciones Yanbal!';
		...
		$strings['InstalledVersion'] = 'Si sta usando la versione %s di Agenda Capacitaciones Yanbal';
