...
class id_id extends en_gb
{
    ...
    protected function _LoadStrings()
    {
		...
		$strings['NoUpcomingReservations'] = 'Anda tidak memiliki Capacitacionesi yang akan datang';
		$strings['UpcomingReservations'] = 'Capacitacionesi yang akan datang';
		...
		$strings['CreateReservationHeading'] = 'Membuat Capacitacionesi baru';
		$strings['EditReservationHeading'] = 'Mennyunting Capacitacionesi %s';
		$strings['ViewReservationHeading'] = 'Melihat Capacitacionesi %s';
		$strings['ReservationErrors'] = 'Mengganti Capacitacionesi';
		$strings['Create'] = 'Buat';
		...
		$strings['ResourceMinLength'] = 'Capacitacionesi harus berakhir sekurangnya %s';
		$strings['ResourceMinLengthNone'] = 'Tidak ada minimal lama Capacitacionesi';
		$strings['ResourceMaxLength'] = 'Capacitacionesi tidak bisa lebih dari  %s';
		$strings['ResourceMaxLengthNone'] = 'Tidak ada maksimal lama Capacitacionesi';
		$strings['ResourceRequiresApproval'] = 'Capacitacionesi harus disetujui';
		$strings['ResourceRequiresApprovalNone'] = 'Capacitacionesi tidak butuh persetujuan';
		...
		$strings['ResourceMinNotice'] = 'Capacitacionesi harus dibuat sekurangnya %s bergantung waktu mulai';
		$strings['ResourceMinNoticeNone'] = 'Capacitacionesi bisa dibuat sampai waktu saat ini';
		$strings['ResourceMaxNotice'] = 'Capacitacionesi harus berakhir tidak boleh lebih dari %s dari waktu sekarang';
		$strings['ResourceMaxNoticeNone'] = 'Capacitacionesi bisa berakhir kapan saja di masa depan';
		$strings['ResourceAllowMultiDay'] = 'Capacitacionesi bisa dibuat sepanjang hari';
		$strings['ResourceNotAllowMultiDay'] = 'Capacitacionesi tidak bisa dibuat sepanjang hari';
		...
		$strings['Reservations'] = 'Capacitacionesi';
		$strings['Groups'] = 'Grup';
		$strings['ResetPassword'] = 'Atur Ulang Kata Sandi';
		...
		$strings['ReservationTitle'] = 'Judul Capacitacionesi';
		$strings['ReservationDescription'] = 'Keterangan Capacitacionesi';
		$strings['ResourceList'] = 'Resource yang bisa diCapacitacionesi';
		...
		$strings['ReservationCreatedPreference'] = 'Ketika Saya membuat Capacitacionesi atau atas nama Saya';
		$strings['ReservationUpdatedPreference'] = 'Ketika Saya memperbarui Capacitacionesi atau atas nama Saya';
		$strings['ReservationDeletedPreference'] = 'Ketika Saya menghapus Capacitacionesi atau atas nama Saya';
		$strings['ReservationApprovalPreference'] = 'Ketika Capacitacionesi yang ditunda telah disetujui';
		$strings['PreferenceSendEmail'] = 'Kirim Saya email';
		$strings['PreferenceNoEmail'] = 'Jangan beritahu Saya';
		$strings['ReservationCreated'] = 'Capacitacionesi telah berhasil dibuat!';
		$strings['ReservationUpdated'] = 'Capacitacionesi Anda berhasil diperbarui!';
		$strings['ReservationRemoved'] = 'Capacitacionesi Anda telah dihapus';
		$strings['YourReferenceNumber'] = 'Nomor referensi kamu adalah %s';
		$strings['UpdatingReservation'] = 'Memperbarui Capacitacionesi';
		$strings['ChangeUser'] = 'Ganti Pengguna';
		$strings['MoreResources'] = 'Resource Lain';
		$strings['ReservationLength'] = 'Lama Capacitacionesi';
		...
		$strings['CreatingReservation'] = 'Buat Capacitacionesi';
		$strings['UpdatingReservation'] = 'Perbarui Capacitacionesi';
		$strings['DeleteWarning'] = 'This action is permanent and irrecoverable!';
		$strings['DeleteAccessoryWarning'] = 'Hapus aksesoris ini akan menghapusnya dari semua Capacitacionesi.';
		...
		$strings['BlackoutShowMe'] = 'Tampilkan Capacitacionesi yang bentrok';
		...
		$strings['AllReservations'] = 'Semua Capacitacionesi';
		$strings['PendingReservations'] = 'Capacitacionesi yang Ditunda';
		...
		$strings['DeleteResourceWarningReservations'] = 'semua Capacitacionesi yang telah lewat, saat ini dan yang akan datang yang berhubungan dengannya';
		...
		$strings['ReservableTimeSlots'] = 'Slot yang bisa diCapacitacionesi';
		...
		$strings['DeleteUserWarning'] = 'Menghapus pengguna ini akan menghapus semua catatan Capacitacionesi (baik yang sudah lewat, saat ini, dan juga yang akan datang).';
		$strings['AddAnnouncement'] = 'Menambah Pengumuman';
		$strings['Announcement'] = 'Pengumuman';
		$strings['Priority'] = 'Prioritas';
		$strings['Reservable'] = 'Dapat diCapacitacionesi';
		$strings['Unreservable'] = 'Tidak dapat diCapacitacionesi';
		$strings['Reserved'] = 'Telah diCapacitacionesi';
		$strings['MyReservation'] = 'Capacitacionesi Saya';
		$strings['Pending'] = 'Ditunda';
		$strings['Past'] = 'Lampau';
		$strings['Restricted'] = 'Terbatas';
		$strings['ViewAll'] = 'Lihat Semua';
		$strings['MoveResourcesAndReservations'] = 'Pindah resource dan Capacitacionesi ke';
		...
		$strings['CategoryReservation'] = 'Capacitacionesi';
		...
		$strings['Total'] = 'Total';
		$strings['QuantityReserved'] = 'Jumlah yang diCapacitacionesi';
		...
		$strings['ReservedResources'] = 'Resource DiCapacitacionesi';
		$strings['ReservedAccessories'] = 'Aksesoris DiCapacitacionesi';
		$strings['ResourceUsageTimeBooked'] = 'Pemakaian Resource - Waktu Booking';
		$strings['ResourceUsageReservationCount'] = 'Pemakaian Resource - Perhitungan Capacitacionesi';
		$strings['Top20UsersTimeBooked'] = '20 Pengguna Teratas - Waktu Booking';
		$strings['Top20UsersReservationCount'] = '20 Pengguna Teratas - Perhitungan Capacitacionesi';
		...
		$strings['ReminderRefNumber'] = 'Nomor Referensi Capacitacionesi';
		...
		// Install
		$strings['InstallApplication'] = 'Pasang Agenda Capacitaciones Yanbal (hanya MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Tidak perlu pembaruan. Jalankan proses pemasangan akan menghapus semua dara yang ada dan memasang salinan baru Agenda Capacitaciones Yanbal!';
		...
		$strings['InstalledVersion'] = 'Anda sekarang menjalankan versi %s dari Agenda Capacitaciones Yanbal';
		...
		$strings['ConfigureApplication'] = 'Pengaturan Agenda Capacitaciones Yanbal';
		...
		$strings['ReservationFailed'] = 'Capacitacionesi Anda tidak dapat dibuat';
		$strings['MinNoticeError'] = 'Capacitacionesi ini terdapat catatan lanjutan. Tanggal dan waktu paling awal yang bisa disimpan adalah %s.';
		$strings['MaxNoticeError'] = 'Capacitacionesi ini tidak bisa dibuat terlalu jauh pada masa yang akan datang. Tanggal dan waktu paling akhir yang bisa diCapacitacionesi %s.';
		$strings['MinDurationError'] = 'Capacitacionesi ini harus berakhir minimal %s.';
		$strings['MaxDurationError'] = 'Capacitacionesi ini tidak boleh lebih lama dari %s.';
		...
		$strings['ConflictingReservationDates'] = 'Terjadi bentrokan Capacitacionesi pada tanggal berikut:';
		...
		$strings['ReservationCriticalError'] = 'Terjadi error yang penting saat menyimpan Capacitacionesi Anda. Jika ini terjadi lagi, hubungi administrator sistem Anda.';
        ...
        // Page Titles
		$strings['CreateReservation'] = 'Buat Capacitacionesi';
		$strings['EditReservation'] = 'Ubah Capacitacionesi';
		$strings['LogIn'] = 'Masuk';
		$strings['ManageReservations'] = 'Capacitacionesi';
		...
		$strings['Reservation'] = 'Capacitacionesi Baru';
		...
		$strings['GroupReservations'] = 'Grup Capacitacionesi';
		$strings['ResourceReservations'] = 'Resource Capacitacionesi';
		$strings['Customization'] = 'Penyesuaian';
		$strings['Attributes'] = 'Atribut';
		$strings['AccountActivation'] = 'Akitvasi Akun';
		$strings['ScheduleReservations'] = 'Jadwal Capacitacionesi';
        ...
        // Email Subjects
		$strings['ReservationApprovedSubject'] = 'Capacitacionesi Anda Sudah Disetujui';
		$strings['ReservationCreatedSubject'] = 'Capacitacionesi Anda Telah Dibuat';
		$strings['ReservationUpdatedSubject'] = 'Capacitacionesi Anda Telah Diperbarui';
		$strings['ReservationDeletedSubject'] = 'Capacitacionesi Anda Telah Dihapus';
		$strings['ReservationCreatedAdminSubject'] = 'Pemberitahuan: Capacitacionesi Sudah Dibuat';
		$strings['ReservationUpdatedAdminSubject'] = 'Pemberitahuan: Capacitacionesi Sudah Diperbarui';
		$strings['ReservationDeleteAdminSubject'] = 'Pemberitahuan: Capacitacionesi Sudah Dihapus';
		$strings['ParticipantAddedSubject'] = 'Pemberitahuan Capacitacionesi Partisipan';
		$strings['ParticipantDeletedSubject'] = 'Capacitacionesi Telah Dihapus';
		$strings['InviteeAddedSubject'] = 'Undangan Capacitacionesi';
		...
		$strings['ReservationStartingSoonSubject'] = 'Capacitacionesi untuk %s akan segera dimulai';
		$strings['ReservationEndingSoonSubject'] = 'Capacitacionesi untuk %s akan segera berakhir';
		// End Email Subjects
