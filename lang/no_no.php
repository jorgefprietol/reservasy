...
class no_no extends en_gb
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['NoUpcomingReservations'] = 'Du har ingen kommende Capacitacionesjoner';
		$strings['UpcomingReservations'] = 'Kommende Capacitacionesjoner';
		$strings['AllNoUpcomingReservations'] = 'Det finnes ingen kommnde Capacitacionesjoner';
		$strings['AllUpcomingReservations'] = 'Alle kommende Capacitacionesjoner';
		...
		$strings['CreateReservationHeading'] = 'Opprett en ny Capacitacionesjon';
		$strings['EditReservationHeading'] = 'Redigerer Capacitacionesjonen %s';
		$strings['ViewReservationHeading'] = 'Viser reservation %s';
		$strings['ReservationErrors'] = 'Endre Capacitacionesjon';
		...
		$strings['ResourceMinLength'] = 'Capacitacionesjonen må ha en varighet på minst %s';
		$strings['ResourceMinLengthNone'] = 'Det er ingen minimum Capacitacionesjonstid';
		$strings['ResourceMaxLength'] = 'Capacitacionesjonen kan ikke vare lengre enn %s';
		$strings['ResourceMaxLengthNone'] = 'Det er ingen maksimum Capacitacionesjonstid';
		$strings['ResourceRequiresApproval'] = 'Capacitacionesjoner må godkjennes';
		$strings['ResourceRequiresApprovalNone'] = 'Capacitacionesjoner trenger ikke godkjennes';
		...
		$strings['ResourceMinNotice'] = 'Capacitacionesjoner må gjøres minst %s før starttid';
		$strings['ResourceMinNoticeNone'] = 'Capacitacionesjoner kan gjøres fram til nåværende tidspunkt';
		$strings['ResourceMaxNotice'] = 'Capacitacionesjoner kan ikke ha endetidspunkt nærmere enn %s fra nåværende tidspunkt';
		$strings['ResourceMaxNoticeNone'] = 'Ingen grense for sluttidspunkt';
		$strings['ResourceBufferTime'] = 'Det må være %s mellom Capacitacionesjoner';
		$strings['ResourceBufferTimeNone'] = 'Det er ingen buffer mellom Capacitacionesjoner';
		$strings['ResourceAllowMultiDay'] = 'Capacitacionesjoner kan gjøres over flere dager';
		$strings['ResourceNotAllowMultiDay'] = 'Capacitacionesjoner kan ikke gjøres over flere dager';
		...
		$strings['Reservations'] = 'Capacitacionesjoner';
		...
		$strings['reservations'] = 'Capacitacionesjoner';
		$strings['reservation'] = 'Capacitacionesjon';
		...
		$strings['ReservationTitle'] = 'Capacitacionesjonstittel';
		$strings['ReservationDescription'] = 'Capacitacionesjonsbeskrivelse';
		$strings['ResourceList'] = 'Enheter til Capacitacionesjon';
		...
		$strings['ReservationCreatedPreference'] = 'Når jeg oppretter en Capacitacionesjon, eller en Capacitacionesjon blir opprettet på mine vegne';
		$strings['ReservationUpdatedPreference'] = 'Når jeg oppdaterer en Capacitacionesjon, eller en Capacitacionesjon blir oppdatert på mine vegne';
		$strings['ReservationDeletedPreference'] = 'Når jeg sletter en Capacitacionesjon, eller en Capacitacionesjon blir slettet på mine vegne';
		$strings['ReservationApprovalPreference'] = 'Når min ventende Capacitacionesjon blir godkjent';
		$strings['PreferenceSendEmail'] = 'Send meg en epost';
		$strings['PreferenceNoEmail'] = 'Ikke gi meg tilbakemelding';
		$strings['ReservationCreated'] = 'Din Capacitacionesjon er opprettet!';
		$strings['ReservationUpdated'] = 'Din Capacitacionesjon er oppdatert!';
		$strings['ReservationRemoved'] = 'Din Capacitacionesjon ble fjernet';
		$strings['ReservationRequiresApproval'] = 'En eller flere av enhetsCapacitacionesjonene trenger godkjenning før den er gjeldende.  Denne        Capacitacionesjonen   er kun midlertidig fram til den er godkjent.';
		$strings['YourReferenceNumber'] = 'Ditt referansenummer er %s';
		$strings['UpdatingReservation'] = 'Oppdaterer Capacitacionesjonen';
		$strings['ChangeUser'] = 'Bytt bruker';
		$strings['MoreResources'] = 'Flere enheter';
		$strings['ReservationLength'] = 'Capacitacionesjonslengde';
		...
		$strings['CreatingReservation'] = 'Oppretter Capacitacionesjon';
		$strings['UpdatingReservation'] = 'Oppdaterer Capacitacionesjon';
		$strings['DeleteWarning'] = 'Denne handlingen er permanent og kan ikke angres!';
		$strings['DeleteAccessoryWarning'] = 'Sletting av dette tilbehøret vil fjerne det fra alle Capacitacionesjoner.';
		...
		$strings['BlackoutShowMe'] = 'Vis Capacitacionesjoner i konflikt';
		$strings['BlackoutDeleteConflicts'] = 'Slett Capacitacionesjoner i konflikt';
		...
		$strings['ReservationConflicts'] = 'Det er konflikt mellom Capacitacionesjonstider';
		...
		$strings['AllReservations'] = 'Alle Capacitacionesjoner';
		$strings['PendingReservations'] = 'Capacitacionesjoner som avventer godkjenning';
		...
		$strings['DeleteResourceWarningReservations'] = 'alle foregående, nåværende og fremtidige Capacitacionesjoner assosiert med den';
		...
		$strings['DeleteUserWarning'] = 'Ved å slette denne brukeren, fjerner du også alle hans foregående, nåværende og fremtidige Capacitacionesjoner.';
		...
		$strings['MyReservation'] = 'Min Capacitacionesjon';
		...
		$strings['MoveResourcesAndReservations'] = 'Flytt enheter og Capacitacionesjoner til';
		...
		$strings['CategoryReservation'] = 'Capacitacionesjon';
		...
		$strings['ResourceUsageReservationCount'] = 'Bruk av enheter - Antall Capacitacionesjoner';
		$strings['Top20UsersTimeBooked'] = 'Top 20 Brukere - Tid booket';
		$strings['Top20UsersReservationCount'] = 'Top 20 Brukere - Antall Capacitacionesjoner';
		...
		// Install
		$strings['InstallApplication'] = 'Installer Agenda Capacitaciones Yanbal (kun MySQL)';
		...
		$strings['NoUpgradeNeeded'] = 'Ingen oppdatering nødvendig. Ved å kjøre en ny innstallasjon vil alle eksisterende data bli slettet og en ny kopi av Agenda Capacitaciones Yanbal vil bli innstallert!';
		...
		$strings['InstalledVersion'] = 'Du kjører nå versjon %s av Agenda Capacitaciones Yanbal';
		...
		$strings['ConfigureApplication'] = 'Konfigurer Agenda Capacitaciones Yanbal';
		...
		$strings['ReservationFailed'] = 'Din Capacitacionesjon kunne ikke opprettes';
		$strings['MinNoticeError'] = 'Denne Capacitacionesjonen krever forhåndsbooking.  Kan tidligst reserveres %s.';
		$strings['MaxNoticeError'] = 'Capacitacionesjonen kan ikke utføres så langt frem i tid.  The latest date and time that can be reserved is %s.';
		$strings['MinDurationError'] = 'Capacitacionesjonen må vare minst %s.';
		$strings['MaxDurationError'] = 'Capacitacionesjonen kan ikke vare lengre enn %s.';
		...
		$strings['ConflictingReservationDates'] = 'Det er konflikt i Capacitacionesjonene på følgende datoer:';
		...
		$strings['ReservationCriticalError'] = 'Det oppsto en kritisk feil under lagringen av din Capacitacionesjon. Kontakt administrator om problemet fortsetter.';
		...
		$strings['MultiDayRule'] = '%s tillater ikke Capacitacionesjoner over flere dager.';
		$strings['InvalidReservationData'] = 'Det oppsto et problem med din anmodning om Capacitacionesjon.';
		...
		$strings['NoReservationAccess'] = 'Du har ikke tilgangsrettigheter til å endre denne Capacitacionesjonen.';
		...
		// Page Titles
		$strings['CreateReservation'] = 'Opprett Capacitacionesjon';
		$strings['EditReservation'] = 'Redigere Capacitacionesjon';
		$strings['LogIn'] = 'Logg inn';
		$strings['ManageReservations'] = 'Capacitacionesjoner';
		...
		$strings['Reservation'] = 'Ny Capacitacionesjon';
		...
		$strings['GroupReservations'] = 'GruppeCapacitacionesjoner';
		$strings['ResourceReservations'] = 'EnhetsCapacitacionesjoner';
		$strings['Customization'] = 'Personlige innstillinger';
		$strings['Attributes'] = 'Attributter';
		$strings['AccountActivation'] = 'Kontoaktivering';
		$strings['ScheduleReservations'] = 'Opprett Capacitacionesjoner';
		...
		// Email Subjects
		$strings['ReservationApprovedSubject'] = 'Din Capacitacionesjon er godkjent';
		$strings['ReservationCreatedSubject'] = 'Din Capacitacionesjon ble opprettet';
		$strings['ReservationUpdatedSubject'] = 'Din Capacitacionesjon ble oppdatert';
		$strings['ReservationDeletedSubject'] = 'Din Capacitacionesjon ble slettet';
		$strings['ReservationCreatedAdminSubject'] = 'Kunngjøring: En Capacitacionesjon ble opprettet';
		$strings['ReservationUpdatedAdminSubject'] = 'Kunngjøring: En Capacitacionesjon ble oppdatert';
		$strings['ReservationDeleteAdminSubject'] = 'Kunngjøring: En Capacitacionesjon ble slettet';
		$strings['ReservationApprovalAdminSubject'] = 'Kunngjøring: En Capacitacionesjon trenger godkjenning';
		$strings['ParticipantAddedSubject'] = 'Kunngjøring: Deltaker lagt til en Capacitacionesjon';
		$strings['ParticipantDeletedSubject'] = 'Capacitacionesjon fjernet';
		$strings['InviteeAddedSubject'] = 'Capacitacionesjonsinvitasjon';
		...
		$strings['ReservationStartingSoonSubject'] = 'Capacitacionesjonen av %s starter om kort tid';
		$strings['ReservationEndingSoonSubject'] = 'Capacitacionesjonen av %s slutter snart';
