...
class es extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['ScheduleCalendar'] = 'Calendario de Capacitaciones';
        $strings['Registration'] = 'Registro';
        $strings['NoAnnouncements'] = 'No hay anuncios';
        $strings['Announcements'] = 'Anuncios';
        $strings['NoUpcomingReservations'] = 'No tienes Capacitaciones próximas';
        $strings['UpcomingReservations'] = 'Próximas Capacitaciones';
        $strings['AllNoUpcomingReservations'] = 'No tienes Capacitaciones en los próximos %s días';
        $strings['AllUpcomingReservations'] = 'Todas las Capacitaciones próximas';
        ...
        $strings['CreateReservationHeading'] = 'Crear una nueva capacitación';
        $strings['EditReservationHeading'] = 'Editando reserva %s';
        $strings['ViewReservationHeading'] = 'Viendo reserva %s';
        $strings['ReservationErrors'] = 'Cambiar capacitación';
        ...
        $strings['AllResources'] = 'Todos los Salas';
        ...
        $strings['ResourceMinLength'] = 'Las Capacitaciones deben durar por lo menos %s';
        $strings['ResourceMinLengthNone'] = 'No hay duración mínima de capacitación';
        $strings['ResourceMaxLength'] = 'Las Capacitaciones no pueden durar más de %s';
        $strings['ResourceMaxLengthNone'] = 'No hay duración máxima de capacitación';
        $strings['ResourceRequiresApproval'] = 'Las Capacitaciones deben ser aprobadas';
        $strings['ResourceRequiresApprovalNone'] = 'Las Capacitaciones no requieren ser aprobadas';
        ...
        $strings['ResourceMinNotice'] = 'Las Capacitaciones deben realizarse al menos %s antes del tiempo de inicio';
        $strings['ResourceMinNoticeNone'] = 'Las Capacitaciones se pueden realizar hasta la hora actual';
        $strings['ResourceMinNoticeUpdate'] = 'Las Capacitaciones pueden actualizarse al menos %s antes del tiempo de inicio';
        $strings['ResourceMinNoticeNoneUpdate'] = 'Las Capacitaciones se pueden actualizar hasta la hora de inicio';
        $strings['ResourceMinNoticeDelete'] = 'Las Capacitaciones pueden borrarse al menos %s antes del tiempo de inicio';
        $strings['ResourceMinNoticeNoneDelete'] = 'Las Capacitaciones se pueden borrar hasta la hora de inicio';
        $strings['ResourceMaxNotice'] = 'Las Capacitaciones no deben durar más de %s desde la hora actual';
        $strings['ResourceMaxNoticeNone'] = 'Las Capacitaciones pueden terminar en cualquier momento futuro';
        $strings['ResourceBufferTime'] = 'Debe de haber %s entre Capacitaciones';
        $strings['ResourceBufferTimeNone'] = 'No hay tiempo entre Capacitaciones';
        $strings['ResourceAllowMultiDay'] = 'Las Capacitaciones pueden extenderse a lo largo de días';
        $strings['ResourceNotAllowMultiDay'] = 'Las Capacitaciones no pueden extenderse a lo largo de días';
        ...
        $strings['AllSchedules'] = 'Todas las Campañas';
        ...
        $strings['reservations'] = 'Capacitaciones';
        $strings['reservation'] = 'capacitación';
        ...
        $strings['ReservationTitle'] = 'Título de la capacitación';
        $strings['ReservationDescription'] = 'Descripción de la capacitación';
        ...
        $strings['ReservationRequiresApproval'] = 'Uno o más de los Salas reservados requieren aprobación antes de su uso. Esta reserva queará pendiente hasta que sea aprobada.';
        $strings['YourReferenceNumber'] = 'Tu número de referencia es %s';
        $strings['ChangeUser'] = 'Cambiar usuario';
        $strings['MoreResources'] = 'Más Salas';
        $strings['ReservationLength'] = 'Duración de la capacitación';
        ...
        $strings['AddResources'] = 'Agregar Salas';
        $strings['AddAccessories'] = 'Agregar Accesorios';
        $strings['Accessory'] = 'Accesorio';
        $strings['QuantityRequested'] = 'Cantidad requerida';
        $strings['CreatingReservation'] = 'Creando capacitación';
        $strings['UpdatingReservation'] = 'Actualizando capacitación';
        $strings['DeleteWarning'] = '¡Esta acción es permanente e irrecuperable!';
        $strings['DeleteAccessoryWarning'] = 'Al borrar este accesorio se eliminará de todas las Capacitaciones.';
        $strings['AddAccessory'] = 'Agregar accesorio';
        $strings['AddBlackout'] = 'Agregar No Disponibilidad';
        $strings['AllResourcesOn'] = 'Todos los Salas habilitados';
        $strings['Reason'] = 'Razón';
        $strings['BlackoutShowMe'] = 'Muéstrame Capacitaciones en conflicto';
        $strings['BlackoutDeleteConflicts'] = 'Borrar las Capacitaciones en conflicto';
        ...
        $strings['DeleteGroupWarning'] = 'Al borrar este grupo se eliminarán todos los permisos de los Salas asociados.  Los usuarios en este grupo pueden perder acceso a los Salas.';
        ...
        $strings['QuotaReminder'] = 'Recordatorio: las cuotas se fijan basándose en la zona horaria de las Campañas.';
        $strings['AllReservations'] = 'Todas las Capacitaciones';
        $strings['PendingReservations'] = 'Capacitaciones pendientes';
        ...
        $strings['DeleteResourceWarningReservations'] = 'todos las Capacitaciones pasadas, actuales y futuras asociadas';
        ...
        $strings['UserPermissionInfo'] = 'El acceso real a los Salas puede ser diferente dependiendo de los roles del usuario, permisos de grupo, o ajustes externos de permisos';
        $strings['DeleteUserWarning'] = 'Al borrar este usuario se eliminarán todas sus Capacitaciones actuales, futuras y pasadas.';
        ...
        $strings['MyReservation'] = 'Mi capacitación';
        $strings['Pending'] = 'Pendiente';
        $strings['Past'] = 'Pasado';
        $strings['Restricted'] = 'Restringido';
        $strings['ViewAll'] = 'Ver todo';
        $strings['MoveResourcesAndReservations'] = 'Mover Salas y Capacitaciones a';
        ...
        $strings['CategoryReservation'] = 'capacitación';
        ...
        $strings['ResourceUsageReservationCount'] = 'Uso de recurso - número de Capacitaciones';
        $strings['Top20UsersTimeBooked'] = 'Top 20 - Tiempo reservado';
        $strings['Top20UsersReservationCount'] = 'Top 20 - Número de Capacitaciones';
        ...
        $strings['ReminderRefNumber'] = 'Número de referencia de la capacitación';
        ...
        $strings['ResourceGroupHelp1'] = 'Arrastra los grupos de Salas a organizar.';
        $strings['ResourceGroupHelp2'] = 'Haz clic con el botón derecho sobre el nombre de un grupo de Salas para acciones adicionales.';
        $strings['ResourceGroupHelp3'] = 'Arrastra los Salas para agregarlos a los grupos.';
        $strings['ResourceGroupWarning'] = 'Si usas los grupos de Salas, cada recurso debe estar asignado al menos a un grupo. Los Salas no asignados no estarán disponibles para ser reservados.';
        ...
        $strings['AllReservationResources'] = 'Todos los Salas de las Capacitaciones';
        $strings['File'] = 'Fichero';
        $strings['BulkResourceUpdate'] = 'Actualización masiva de Salas';
        ...
        $strings['AddReservationColorRule'] = 'Agregar regla de color de capacitación';
        ...
        $strings['AllResourceTypes'] = 'Todos los tipos de Salas';
        $strings['AllResourceStatuses'] = 'Todos los estados de los Salas';
        $strings['AllowParticipantsToJoin'] = 'Permitir a los participantes unirse';
        $strings['Join'] = 'Unirse';
        $strings['YouAreAParticipant'] = 'Participas en esta capacitación';
        $strings['YouAreInvited'] = 'Estás invitado a esta capacitación';
        $strings['YouCanJoinThisReservation'] = 'Puedes unirte a esta capacitación';
        ...
        $strings['IncludingCompletedReservations'] = 'Incluyendo las Capacitaciones completadas';
        $strings['NotCountingCompletedReservations'] = 'Sin incluir las Capacitaciones completadas';
        $strings['RetrySkipConflicts'] = 'Omitir las Capacitaciones que entran en conflicto';
        ...
        $strings['UsersWithAccessToResources'] = 'Usuarios con acceso a Salas';
        ...
        $strings['IcsLocationsAsResources'] = 'Las ubicaciones serán importadas como Salas.';
        $strings['IcsMissingOrganizer'] = 'Si un evento no tiene organizador, el propietario será el usuario actual.';
        $strings['IcsWarning'] = 'Las reglas de Capacitaciones no se aplicarán - conflictos, duplicados, etc son posibles.';
        ...
        $strings['IncludeDeleted'] = 'Incluir Capacitaciones borradas';
        ...
        $strings['ResourceImportInstructions'] = '<ul><li>El fichero debe tener formato CSV con codificación UTF-8.</li><li>El nombre es un campo obligatorio. Dejar otros campos en blanco establecerá los valores por defecto.</li><li>Los estados disponibles son \'Disponible\', \'No disponible\' and \'Oculto\'.</li><li>El color será el formato hexadecimal. ex) #ffffff.</li><li>Las columnas de asignación y aprobación automática pueden ser verdadero o falso.</li><li>La validez del atributo no se aplicará.</li><li>Separar por comas los grupos de Salas.</li><li>Utilice la plantilla suministrada como ejemplo.</li></ul>';
        $strings['ReservationImportInstructions'] = '<ul><li>El fichero debe tener formato CSV con codificación UTF-8.</li><li>Correo electrónico, nombre del recurso, comienzo y finalización son campos obligatorios.</li><li>Comienzo y finalización requieren la fecha completa. El formato recomendado es YYYY-mm-dd HH:mm (2017-12-31 20:30).</li><li>Las reglas, los conflictos y los intervalos de tiempo válidos no serán verificados.</li><li>No se enviarán notificaciones.</li><li>La validez del atributo no se aplicará.</li><li>Separar por comas los grupos de Salas.</li><li>Utilice la plantilla suministrada como ejemplo.</li></ul>';
        $strings['AutoReleaseMinutes'] = 'Autorelease Minutes';
        $strings['CreditsPeak'] = 'Credits (peak)';
        $strings['CreditsOffPeak'] = 'Credits (off peak)';
        $strings['ResourceMinLengthCsv'] = 'Longitud Mínima de capacitación';
        $strings['ResourceMaxLengthCsv'] = 'Longitud Máxima de capacitación';
        ...
        $strings['DeleteMultipleUserWarning'] = 'Eliminar estos usuarios eliminará todas sus Capacitaciones actuales, futuras e históricas. No se enviarán correos electrónicos.';
        $strings['DeleteMultipleReservationsWarning'] = 'No se enviarán correos electrónicos.';
        $strings['ErrorMovingReservation'] = 'Error Moviendo las Capacitaciones';
        ...
        $strings['UpdateResourcesOnImport'] = 'Actualizar los Salas existentes si el nombre ya existe';
        ...
        $strings['UponReservation'] = 'Tras la capacitación';
        ...
        $strings['ConcurrentYes'] = 'Los Salas pueden ser reservados por más de una persona a la vez';
        $strings['ConcurrentNo'] = 'Los Salas no pueden ser reservados por más de una persona a la vez';
        ...
        $strings['ResourceImages'] = 'Salas de Imagenes';
        ...
        $strings['ReservationsWillBeDeleted'] = 'se borrarán las Capacitaciones';
        ...
        $strings['DeletedReservations'] = 'Capacitaciones Borradas';
        $strings['DeleteReservationsBefore'] = 'Borrar Capacitaciones anteriores a';
        ...
        $strings['ViewReservation'] = 'Ver capacitación';
        $strings['PublicId'] = 'Id Público';
        $strings['Public'] = 'Público';
        $strings['AtomFeedTitle'] = '%s Capacitaciones';
        ...
        $strings['List'] = 'Lista';
        $strings['NoReservationsFound'] = 'No se han Encontrado Capacitaciones';
        $strings['EmailReservation'] = 'Dirección de correo electrónico de la capacitación';
        $strings['AdHocMeeting'] = 'Ad hoc Meeting';
        $strings['NextReservation'] = 'Próxima capacitación';
        ...
        $strings['ReservationDetails'] = 'Detalles de la capacitación';
        $strings['StartTime'] = 'Hora de Comienzo';
        $strings['EndTime'] = 'Hora de Fin';
        // End Strings

        // Install
        $strings['InstallApplication'] = 'Instalar Agenda Capacitaciones Yanbal (solo MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'No es necesaria una actualización. ¡Ejecutar el proceso de instalación borrará todos los datos existentes e instalará una copia nueva de Agenda Capacitaciones Yanbal!';
        ...
        $strings['InstalledVersion'] = 'Ahora estás ejecutando la versión %s de Agenda Capacitaciones Yanbal';
        ...
        $strings['MinNoticeErrorUpdate'] = 'Cambiar esta reserva requiere aviso previo. Las Capacitaciones antes del %s no se pueden cambiar.';
        $strings['MinNoticeErrorDelete'] = 'La eliminación de esta reserva requiere aviso previo. Las Capacitaciones antes del %s no se pueden borrar.';
        ...
        $strings['NoResourcePermission'] = 'No tienes permisos para acceder uno o más de los Salas requeridos';
        $strings['ConflictingReservationDates'] = 'Hay conflictos en las Capacitaciones de las siguientes fechas:';
        ...
        $strings['AccessoryResourceRequiredErrorMessage'] = 'El accesorio %s solamente puede reservarse con los Salas %s';
        ...
        $strings['AccessoryResourceAssociationErrorMessage'] = 'El accesorio \'%s\' no puede reservarse con los Salas solicitados';
        ...
        $strings['TitleRequiredRule'] = 'Es obligatorio el título de la capacitación';
        $strings['DescriptionRequiredRule'] = 'Es obligatoria la descripción de la capacitación';
        $strings['WhatCanThisGroupManage'] = '¿Qué puede gestionar este grupo?';
        $strings['ReservationParticipationActivityPreference'] = 'Cuando alguien se une o deja mi capacitación';
        $strings['RegisteredAccountRequired'] = 'Sólo los usuarios registrados pueden realizar Capacitaciones';
        // End Errors

        // Page Titles
        $strings['CreateReservation'] = 'Crear capacitación';
        $strings['EditReservation'] = 'Editar capacitación';
        $strings['LogIn'] = 'Iniciar sesión';
        $strings['ManageReservations'] = 'Gestionar Capacitaciones';
        $strings['AwaitingActivation'] = 'Esperando activación';
        $strings['PendingApproval'] = 'Pendiente de aprobación';
        $strings['ManageSchedules'] = 'Campañas';
        ...
        $strings['ResourceCalendar'] = 'Calendario de Salas';
        $strings['Reservation'] = 'Nueva capacitación';
        ...
        $strings['GroupReservations'] = 'Capacitaciones del grupo';
        ...
        $strings['ScheduleReservations'] = 'Programar Capacitaciones';
        ...
        $strings['ManageResourceGroups'] = 'Grupos de Salas';
        $strings['ManageResourceTypes'] = 'Tipos de Salas';
        $strings['ManageResourceStatus'] = 'Estados de Salas';
        $strings['ReservationColors'] = 'Colores de las Capacitaciones';


        $strings['SearchReservations'] = 'Buscar Capacitaciones';
        ...
        // Email Subjects
        $strings['ReservationApprovedSubject'] = 'Se ha aprobado tu capacitación';
        $strings['ReservationCreatedSubject'] = 'Se ha creado tu capacitación';
        $strings['ReservationUpdatedSubject'] = 'Se ha actualizado tu capacitación';
        $strings['ReservationDeletedSubject'] = 'Se ha eliminado tu capacitación';
        $strings['ReservationCreatedAdminSubject'] = 'Notificación: se ha creado una capacitación';
        $strings['ReservationUpdatedAdminSubject'] = 'Notificación: se ha actualizado una capacitación';
        $strings['ReservationDeleteAdminSubject'] = 'Notificación: se ha eliminado una capacitación';
        $strings['ReservationApprovalAdminSubject'] = 'Notificación: una reserva necesita aprobación';
        $strings['ParticipantAddedSubject'] = 'Notificación de participación en capacitación';
        $strings['ParticipantDeletedSubject'] = 'Eliminación de participación en capacitación';
        $strings['InviteeAddedSubject'] = 'Invitación a capacitación';
