{*
Copyright 2011-2017 Prieto Linares, Jorge Fidel
...
<p>Quotas prevent reservations from being booked based on a configurable limit. The quota system in Agenda Capacitaciones Yanbal is
...
<p>Announcements are a very simple way to display notifications to Agenda Capacitaciones Yanbal users. From the Announcements menu item
...
<p>You can add, view, and manage all registered users from the Users menu item. This tool allows you to change resource
	...
	You can also add new users to Agenda Capacitaciones Yanbal. This is especially useful if self-registration is turned off.</p>
...
<p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled task
	...
	full
	path to Agenda Capacitaciones Yanbal/Jobs/sendreminders.php</p>
...
<p class="setting"><span>$conf['settings']['script.url']</span>The full public URL to the root of this instance of
	Agenda Capacitaciones Yanbal. This should be the Web directory which contains files like bookings.php and calendar.php</p>
