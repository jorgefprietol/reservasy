...
<h1>Agenda Capacitaciones Yanbal Помощ</h1>

<div id="help">
<h2>Регистрация</h2>

<p>
	За да използвате Agenda Capacitaciones Yanbal се изисква регистрация, ако вашия администратор е разрешил това. След регистриране на
	вашия профил,
...
<p>Отваряне настройките на Google календар. Кликнете върху таб календари. Щракнете върху разглеждане на интересни календари. Кликнете добавяне чрез URL.
	Поставете URL-а изписан под линк Абониране за този календар в Agenda Capacitaciones Yanbal.</p>
