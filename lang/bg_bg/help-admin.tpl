...
<h1>Администриране на Agenda Capacitaciones Yanbal</h1>
...
<p>
	При инсталиране на Agenda Capacitaciones Yanbal ще бъде създадено разписание по подразбиране. От меню
...
<p>Ресурс в Agenda Capacitaciones Yanbal може да бъде всичко, което искате да се резервира, като стаи или оборудване. Всеки ресурс
...
<p>Квотите въвеждат ограничения за правене на резервации. Квотите в Agenda Capacitaciones Yanbal са
...
<p>Обявите са лесен начин за уведомяване на потребителите на Agenda Capacitaciones Yanbal. От меню обяви може да се
...
<p>Групите в Agenda Capacitaciones Yanbal организират потребителите, контролират достъпа до ресурсите и дефинират роли в приложението.</p>
...
<p>YМожете да добавяте, преглеждате и управлявате всички регистрирани потребители от меню потребители. Оттук могат да се
	...
	Можете да добавяте нови потребители в Agenda Capacitaciones Yanbal. Това е особено полезно, ако е изклщчена самостоятелната регистрация.</p>

<h3>Отчетност</h3>

<p>Отчетите са достъпни за всички администратори на приложения, групи, ресурси и разписания. След идентифициране на
	потребител с достъп до отчети, ще се покаже навигация за отчети. Agenda Capacitaciones Yanbal разполага с множество от
...
<p>Част от функционалността на Agenda Capacitaciones Yanbal може да бъде контролирана само с редактиране на config файла.</p>

<p class="setting"><span>$conf['settings']['server.timezone']</span>Това е часовата зона на сървъра, където се
	хоства Agenda Capacitaciones Yanbal.
...
<p class="setting"><span>$conf['settings']['enable.email']</span>Дали да бъдат изпращани имейли от Agenda Capacitaciones Yanbal
</p>

<p class="setting"><span>$conf['settings']['default.language']</span>Език по подразбиране за всички потребители. Това може да бъде
	всеки екик, който се поддържа от Agenda Capacitaciones Yanbal, взема се от папка lang</p>

<p class="setting"><span>$conf['settings']['script.url']</span>Пълния публичен URL адрес на този екземпляр на Agenda Capacitaciones Yanbal.
...
<p class="setting"><span>$conf['settings']['image.upload.directory']</span>Физическата директория за съхраняване на изображения.
	...
	корневата директория на Agenda Capacitaciones Yanbal.</p>
...
<p class="setting"><span>$conf['settings']['css.extension.file']</span>Пълен или относителен URL към допълнителен CSS файл
	...
	нама да разширявате стила на Agenda Capacitaciones Yanbal.</p>
...
<p class="setting"><span>$conf['settings']['uploads']['reservation.attachment.path']</span>Пълен или относителен
	път във файловата система (спрямо корневата директория на Agenda Capacitaciones Yanbal) за съхраняване на прикачени файлове. В
...
<p class="setting"><span>$conf['settings']['database']['name']</span>Име на базата данни на Agenda Capacitaciones Yanbal</p>
