...
Denne fil er en del af Agenda Capacitaciones Yanbal.
...
<h1 xmlns="http://www.w3.org/1999/html">Agenda Capacitaciones Yanbal Hjælp</h1>
...
<p>
	Når du installerer Agenda Capacitaciones Yanbal vil en standard tidsplan oprettes med ud af boksen indstillinger. Fra Tidsplaner menuindstillingen kan du se og redigere attributter i de nuværende skemaer.<br />
...
<p>
    ...
    <br />
    Ressourcer i Agenda Capacitaciones Yanbal kan være noget, du ønsker at gøre reserverbart, såsom værelser eller udstyr. Hver ressource skal tildeles til en tidsplan, for at det at kan gøres reserverbart. Ressourcen vil arve et hvilket somhelst layout tidsskemaet bruger.<br />
    <br />
...
<p>
    ...
    Mændeordningen i Agenda Capacitaciones Yanbal er meget fleksibel, så du kan oprette grænser baseret på reservations længde og antallet af reservationer. Desuden mænder begrænser "stacks".<br />
    <br />
...
<p>
	Meddelelser er en meget enkel måde at vise meddelelser til Agenda Capacitaciones Yanbal brugere.<br />
...
<p>
	Grupper i Agenda Capacitaciones Yanbal organisere brugere, kontrollerer ressource adgangstilladelser og definere roller i anvendelsen.
</p>
...
<p>
    ...
    Du kan også tilføje nye brugere til Agenda Capacitaciones Yanbal. Dette er især nyttigt, hvis selvregistrering er slået fra.
</p>

<h2>Konfiguration</h2>

<p>
	Nogle af Agenda Capacitaciones Yanbal funktionaliteter kan kun styres ved at redigere i konfigurationsfilen.<br />
    
<p class="setting">
	<span>$conf['settings']['server.timezone']</span>Dette skal afspejle tidszonen på den server, Agenda Capacitaciones Yanbal er hostet på.<br /> 
...
<p class="setting">
	<span>$conf['settings']['enable.email']</span>Hvorvidt alle e-mails sendes ud af Agenda Capacitaciones Yanbal
</p>

<p class="setting">
	<span>$conf['settings']['default.language']</span>Standard sprog for alle brugere. Dette kan være alle sprog i Agenda Capacitaciones Yanbal sprog biblioteket (booked / lang /)
</p>

<p class="setting">
	<span>$conf['settings']['script.url']</span>Den fulde offentlige webadresse til roden af denne version af Agenda Capacitaciones Yanbal.<br />
...
<p class="setting">
	...
	Denne mappe skal være skrivbar. Dette kan være den fulde sti til biblioteket eller relativ til den Agenda Capacitaciones Yanbals rodmappe.
</p>
...
<p class="setting">
    ...
    Efterlad dette blankt hvis du ikke vil udvide stilen i Agenda Capacitaciones Yanbal.
</p>
...
<p class="setting">
    <span>$conf['settings']['uploads']['reservation.attachment.path']</span>Det fulde eller relative filsystem sti (i forhold til roden af dit Agenda Capacitaciones Yanbals biblioteket) til at gemme reservations vedhæftede filer.<br />
...
<p class="setting">
    <span>$conf['settings']['database']['name']</span>Navnet på Agenda Capacitaciones Yanbals databasen
</p>
