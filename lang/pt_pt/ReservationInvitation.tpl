...
*}
	...
	{if $RequiresApproval}
		<br/>
		Um ou mais Salas reservados requerem aprovação antes do uso. Esta reserva estará pendente até que seja aprovada.
	{/if}
	...
	<a href="{$ScriptUrl}">Entrar no Agenda Capacitaciones Yanbal</a>
