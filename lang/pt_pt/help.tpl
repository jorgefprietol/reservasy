...
<h1>>Ajuda do Agenda Capacitaciones Yanbal</h1>

<div id="help">
<h2>Registration</h2>

<p>
	Registration is required in order to use Agenda Capacitaciones Yanbal if you administrator has enabled it. After your account
	has been registered
...
<p>Open Google Calendar settings. Click the Calendars tab. Click Browse interesting calendars. Click add by URL. Paste
	in the URL printed under the Subscribe to this Calendar link in Agenda Capacitaciones Yanbal.</p>
...
<p>Some of Agenda Capacitaciones Yanbal's functionality can only be controlled by editing the config file.</p>

<p class="setting"><span>$conf['settings']['server.timezone']</span>This must reflect the timezone of the server that
	Agenda Capacitaciones Yanbal is hosted
...
<p class="setting"><span>$conf['settings']['script.url']</span>The full public URL to the root of this instance of
	Agenda Capacitaciones Yanbal. This should
