...
class hr_hr extends en_gb
{
	...
	protected function _LoadStrings()
	{
		...
		// Install
		$strings['InstallApplication'] = 'Instaliraj Agenda Capacitaciones Yanbal (MySQL samo)';
		...
		$strings['InstalledVersion'] = 'Radite u %s verziji Agenda Capacitaciones Yanbal';
		...
		$strings['ConfigureApplication'] = 'Konfiguriraj Agenda Capacitaciones Yanbal';
