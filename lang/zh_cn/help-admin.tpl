...
<h1>Agenda Capacitaciones Yanbal Administration</h1>
...
<div id="help">
    ...
    <div id="help-schedules">
        ...
        <p>
            When installing Agenda Capacitaciones Yanbal a default schedule will be created with out of the box settings. From the
    ...
    <div id="help-resources">
        ...
        <p>Resources in Agenda Capacitaciones Yanbal can be anything you want to make bookable, such as rooms or equipment. Every
            resource
    ...
    <div id="help-groups">
        ...
        <p>
			Groups in Agenda Capacitaciones Yanbal organize users, control resource access permissions and define roles within the
    ...
    <div id="help-users">
        ...
        <p>You can add, view, and manage all registered users from the Users menu item. This tool allows you to change
            ...
            You can also add new users to Agenda Capacitaciones Yanbal, which is especially useful if self-registration is turned
            off.</p>
    ...
    <div id="help-reporting">
        ...
        <p>Reports are accessible to all application, group, resource and schedule administrators. When the currently
            logged in
            user has access to reporting features, they will see a Reports navigation item. Agenda Capacitaciones Yanbal comes with
            a set of
    ...
    <div id="help-reminders">
        ...
        <p>
            ...
            both be set to true. Also, a scheduled task must be configured on your server to execute /Agenda Capacitaciones Yanbal/Jobs/sendreminders.php
			</p>
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            the
            full path to Agenda Capacitaciones Yanbal\Jobs\sendreminders.php. For example, c:\PHP\php.exe -f
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            Agenda Capacitaciones Yanbal/Jobs/autorelease.php. The full path to autorelease.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            The task to execute is php followed by
            the
            full path to Agenda Capacitaciones Yanbal\Jobs\autorelease.php. For example, c:\PHP\php.exe -f
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            Agenda Capacitaciones Yanbal/Jobs/sendwaitlist.php. The full path to sendwaitlist.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            The task to execute is php followed by
            the
            full path to Agenda Capacitaciones Yanbal\Jobs\sendwaitlist.php. For example, c:\PHP\php.exe -f
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            Agenda Capacitaciones Yanbal/Jobs/sendmissedcheckin.php. The full path to sendmissedcheckin.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            The task to execute is php followed by
            the
            full path to Agenda Capacitaciones Yanbal\Jobs\sendmissedcheckin.php. For example, c:\PHP\php.exe -f
    ...
    <div id="help-configuration">
        ...
        <p class="setting"><span>$conf['settings']['image.upload.directory']</span>The physical directory to store
            ...
            Agenda Capacitaciones Yanbal root directory.</p>
        ...
        <p class="setting"><span>$conf['settings']['css.extension.file']</span>Full or relative URL to an additional CSS
            ...
            if you
            are not extending the style of Agenda Capacitaciones Yanbal.</p>
        ...
        <p class="setting"><span>$conf['settings']['uploads']['reservation.attachment.path']</span>The full or relative
            filesystem path (relative to the root of your Agenda Capacitaciones Yanbal directory) to store reservation attachments.
            This
        ...
        <p class="setting"><span>$conf['settings']['database']['name']</span>Name of Agenda Capacitaciones Yanbal database</p>
        ...
        <p class="setting"><span>$conf['settings']['api']['enabled']</span>If the Agenda Capacitaciones Yanbal's RESTful API should
            be enabled.
    ...
    <p class="setting"><span>$conf['settings']['email.suffix']</span>Email suffix to use when storing CAS user account.
        ...
        Agenda Capacitaciones Yanbal as username@yourdomain.com</p>
    ...
    <p class="setting"><span>$conf['settings']['wp_includes.directory']</span>The full path to your wp-includes
        directory or path relative to Agenda Capacitaciones Yanbal
        root.</p>

    <p class="setting"><span>$conf['settings']['database.auth.when.wp.user.not.found']</span>If WordPress auth fails,
        authenticate against Agenda Capacitaciones Yanbal
        database.</p>
