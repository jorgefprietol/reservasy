{*
Copyright 2011-2013 Prieto Linares, Jorge Fidel

Tento súbor je súčasťou phpScheduleIt. 

phpScheduleIt je voľné programové vybavenie: môžete ho šíriť a / alebo modifikovať 
to za podmienok uvedených v licencii GNU General Public License, vydávané 
Free Software Foundation, buď verzie 3 tejto licencie, alebo 
(Podľa vášho uváženia) ktorejkoľvek neskoršej verzie. 

phpScheduleIt je rozširovaný v nádeji, že bude užitočný, 
ale BEZ AKEJKOĽVEK ZÁRUKY; neposkytujú sa ani odvodené záruky 
PREDAJNOSTI alebo VHODNOSTI PRE NEJAKÝ KONKRÉTNY ÚČEL. Pozrite sa 
...
<h1>Rezervácie online</h1>

<div id="help">
<h2>Registrácia</h2>

<p>
	Registrácia je nutná, aby bolo možné používať Rezervácie online, ak je povolené ju budete administrátor. Po vašom účte 
bola zaregistrovaná 
budete môcť prihlásiť a prístup k prostriedkom, ktoré majú oprávnenie.
</p>
