...
<p>
管理者(あなた)が設定していれば、Agenda Capacitaciones Yanbal を使うためにユーザー登録が必要です。
...
<p>予約を削除すると、スケジュールから完全に取り除かれます。Agenda Capacitaciones Yanbal のどこからも見えなくなります</p>
...
Agenda Capacitaciones Yanbal の「カレンダーを購読する」リンクの下に表示されているURLをペーストします。
</p>
