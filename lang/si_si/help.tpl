...
<h1>Pomoč programa Agenda Capacitaciones Yanbal</h1>

<div id="help">
<h2>Registracija</h2>

<p>
	Registracija je potrebna pred uporabo sistema Agenda Capacitaciones Yanbal, če je administrator to omogočil. Po registraciji vašega računa 
...
<p>Brisanje rezervacije jo v celoti odstrani z urnika. Zbrisana rezervacija ne bo več vidna nikjer v sistemu Agenda Capacitaciones Yanbal.</p>
...
<p>V večini primerov bo klik na povezavo Naroči se na ta koledar samodejno vzpostavil naročnino v vašem odjemalcu za koledar. Pri odjemalcu Outlook,
	...
	Prilepite naslov URL, ki je v sistemu Agenda Capacitaciones Yanbal izpisan pod povezano Naroči se na ta koledar.</p>
...
<p>Odprite nastavitve koledarja Google Calendar. Kliknite na zavihek koledarji (Calendars). Kliknite Prebrskaj zanimive koledarje (Browse interesting calendars). 
    Kliknite Dodaj URL. Prilepite naslov URL, ki je v sistemu Agenda Capacitaciones Yanbal izpisan pod povezano Naroči se na ta koledar.</p>
