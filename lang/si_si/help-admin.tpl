...
<h1>Administracija programa Agenda Capacitaciones Yanbal</h1>
...
<div id="help">
	...
	<div id="help-schedules">
		...
		<p>
			Ob namestitvi sistema Agenda Capacitaciones Yanbal se ustvari privzeti urnik z vnaprej določenimi nastavitvami. Lastnosti trenutnega urnika lahko 
	...
	<div id="help-resources">
		...
		<p>Viri v sistemu Agenda Capacitaciones Yanbal so lahko karkoli, kar želimo ponuditi za rezervacijo, npr. prostor ali oprema. Vsak vir mora biti dodeljen
	...
	<div id="help-quotas">
		...
		<p>Quotas restrict reservations from being booked based on a configurable limit. The quota system in Agenda Capacitaciones Yanbal is
	...
	<div id="help-announcements">
		...
		<p>Announcements are a very simple way to display notifications to Agenda Capacitaciones Yanbal users.</p>
	...
	<div id="help-groups">
		...
		<p>Groups in Agenda Capacitaciones Yanbal organize users, control resource access permissions and define roles within the
	...
	<div id="help-users">
		...
		<p>You can add, view, and manage all registered users from the Users menu item. This tool allows you to change resource
			...
			You can also add new users to Agenda Capacitaciones Yanbal, which is especially useful if self-registration is turned off.</p>
	...
	<div id="help-reporting">
		...
		<p>Reports are accessible to all application, group, resource and schedule administrators. When the currently logged in
			user has access to reporting features, they will see a Reports navigation item. Agenda Capacitaciones Yanbal comes with a set of
	...
	<div id="help-reminders">
		...
		<p>Users can request that reminder emails are send prior to the beginning or end of a reservation. In order for this
			...
			/Agenda Capacitaciones Yanbal/Jobs/sendreminders.php</p>

		<p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full path to
			Agenda Capacitaciones Yanbal/Jobs/sendreminders.php. The full path to sendreminders.php on this server is <span
		...
		<p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled task
			...
			the
			full path to Agenda Capacitaciones Yanbal\Jobs\sendreminders.php. For example, c:\PHP\php.exe -f c:\inetpub\wwwroot\Booked\Jobs\sendreminders.php</p>
	...
	<div id="help-configuration">
		...
		<p class="setting"><span>$conf['settings']['app.title']</span>Naslov aplikacije, ki ga uporabi brskalnik. Privzeto je Agenda Capacitaciones Yanbal.</p>
		...
		<p class="setting"><span>$conf['settings']['enable.email']</span>Ali ima sistem Agenda Capacitaciones Yanbal omogočeno pošiljanje elektronske pošte.</p>

		<p class="setting"><span>$conf['settings']['default.language']</span>Privzet jezik za vse uporabnike. To je lahko katerikoli jezik iz direktorija lang datotek Agenda Capacitaciones Yanbal.</p>

		<p class="setting"><span>$conf['settings']['script.url']</span>Poln javni URL do korenskega direktorija te namestitve sistema Agenda Capacitaciones Yanbal. 
		...
		<p class="setting"><span>$conf['settings']['image.upload.directory']</span>Fizični direktorij, v katerem shranjujemo slike.
			Ta direktorij mora imeti pravice za branje in pisanje (zaželene so pravice 755). Direktorij je lahko podan z absolutno potjo ali pa z relativno glede na korenski direktorij sistema Agenda Capacitaciones Yanbal.</p>
		...
		<p class="setting"><span>$conf['settings']['css.extension.file']</span>Absolutni pot ali relativni naslov URL do dodatne vključene datoteke CSS.
			...
			Agenda Capacitaciones Yanbal ne boste razširjali in spreminjali, pustite prazno.</p>
		...
		<p class="setting"><span>$conf['settings']['uploads']['reservation.attachment.path']</span>Absolutna ali relativna pot v datotečnem sistemu 
		    (relativna na korenski direktorij namestitve sistema Agenda Capacitaciones Yanbal) do shranjenih priponk k rezervacijam. Ta direktorij mora imeti 
		...
		<p class="setting"><span>$conf['settings']['database']['name']</span>Ime podatkovne baze za Agenda Capacitaciones Yanbal.</p>
		...
		<p class="setting"><span>$conf['settings']['api']['enabled']</span>Ali naj bo omogočen vmesnik RESTful API programa Agenda Capacitaciones Yanbal.
	...
	<p class="setting"><span>$conf['settings']['database.auth.when.ldap.user.not.found']</span>Če avtentikacija preko Active Directory ne uspe, 
	    uporabi avtentikacijo preko podatkovne baze sistema Agenda Capacitaciones Yanbal.</p>
	...
	<p class="setting"><span>$conf['settings']['email.suffix']</span>Končnica e-pošte, ki se uporabi ob shranjevanju uporabniškega računa CAS. ex) E-poštni naslovi bodo shranjeni
		v Agenda Capacitaciones Yanbal kot username@yourdomain.com</p>
	...
	<p class="setting"><span>$conf['settings']['wp_includes.directory']</span>Celotna absolutna pot do direktorija wp-includes ali relativna pot od korenskega direktorija Agenda Capacitaciones Yanbal.</p>

	<p class="setting"><span>$conf['settings']['database.auth.when.wp.user.not.found']</span>Če avtentikacija preko WordPressa ne uspe, uporabi avtentikacijo preko podatkovne baze sistema Agenda Capacitaciones Yanbal.</p>
