...
<div id="help">
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            Agenda Capacitaciones Yanbal/Jobs/sendwaitlist.php. The full path to autorelease.php on this server is <span
    ...
    <div id="help-configuration">
        ...
        <p class="setting"><span>$conf['settings']['script.url']</span>The full public URL to the root of this instance
            of
            Agenda Capacitaciones Yanbal. This should be the Web directory which contains files like bookings.php and calendar.php.
            If this
