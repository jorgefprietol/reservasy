...
class du_nl extends en_gb
{
	...
	protected function _LoadStrings()
	{
		...
		// Install
		$strings['InstallApplication'] = 'Installeer Agenda Capacitaciones Yanbal (MySQL only)';
		...
		$strings['NoUpgradeNeeded'] = 'Er is geen upgrade nodig. De installatie zal alle bestaande data verwijderen en zal een nieuwe kopie gemaakt worden van Agenda Capacitaciones Yanbal!';
		...
		$strings['InstalledVersion'] = 'Je zit nu op versie %s van Agenda Capacitaciones Yanbal';
		...
		$strings['ConfigureApplication'] = 'Configureer Agenda Capacitaciones Yanbal';
