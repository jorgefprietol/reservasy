...
<h1>Aide Agenda Capacitaciones Yanbal</h1>

<div id="help">
<h2>Enregistrement</h2>

<p>L'enregistrement est obligatoire pour utiliser Agenda Capacitaciones Yanbal.
...
Pour Outlook, si cela ne fonctionne pas, ajouter manuellement un calendrier dans le logiciel en copiant l'URL fournie lors de l'inscription au calendrier de Agenda Capacitaciones Yanbal.</p>

<h3>Agenda Google&reg;</h3>

<p>Cliquez sur la flèche d' "Autres agendas" puis sur "Ajouter par URL". Copiez l'URL fournie lors de l'inscription dans Agenda Capacitaciones Yanbal.</p>
